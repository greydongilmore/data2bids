...
class checkEDFheader:
	...
	def as_dict(self):
		header={'__annot_ch': self.__annot_ch,
				'__data_record_duration': self.__data_record_duration,
				'__datarecords': self.__datarecords,
				'__edfsignals': self.__edfsignals,
				'__mapped_signals': self.__mapped_signals,
				'__nr_annot_chns': self.__nr_annot_chns,
				'__param_annotation': self.__param_annotation,
				'__param_bitvalue': self.__param_bitvalue,
				'__param_buf_offset': self.__param_buf_offset,
				'__param_dig_max': self.__param_dig_max,
				'__param_dig_min': self.__param_dig_min,
				'__param_label': self.__param_label,
				'__param_offset': self.__param_offset,
				'__param_phys_max': self.__param_phys_max,
				'__param_phys_min': self.__param_phys_min,
				'__param_physdimension': self.__param_physdimension,
				'__param_prefilter': self.__param_prefilter,
				'__param_physdimension': self.__param_physdimension,
				'__param_sample_pntr': self.__param_sample_pntr,
				'__param_smp_per_record': self.__param_smp_per_record,
				'__param_transducer': self.__param_transducer,
				'__patient': self.__patient,
