...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.loadDirButton.sizePolicy().hasHeightForWidth())
        self.loadDirButton.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.outDirButton.sizePolicy().hasHeightForWidth())
        self.outDirButton.setSizePolicy(sizePolicy3)
